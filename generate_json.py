...
def get_img_src(pokemon_name, pokemon_image):
    img_src = 'https://marriland.com/wp-content/plugins/marriland-core/images/pokemon/sprites/home/full/'
    if pokemon_image:
        img_src += pokemon_image + '.png'
    elif '(M)' in pokemon_name:
        img_src += pokemon_name.lower()[:-4] + '.png'
    elif '(F)' in pokemon_name:
        img_src += pokemon_name.lower()[:-4] + '-female.png'
